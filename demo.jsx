  ...
  render() {
    ...
    return <div>
      ...
      <section className="modal-btn-single-fullheight-static">
        ...
        <div className="content"><Btn Form={StaticModal} className="fullheight" onClose={onClose}>Click to open</Btn></div>
      </section>
      <section className="modal-btn-single-center-block-static">
        ...
        <div className="content"><Btn Form={StaticModal} className="center-block" onClose={onClose}>Click to open</Btn></div>
      </section>
      <section className="modal-btn-single-fullheight-form">
        <header>&lt;Btn Form=ModalForm className="fullheight"&gt; (with form)</header>
        <div className="content"><Btn Form={ModalForm} className="fullheight" onClose={onClose}>Click to open</Btn></div>
      </section>
      <section className="modal-btn-single-center-block-form">
        <header>&lt;Btn Form=ModalForm className="center-block"&gt; (with form)</header>
        <div className="content"><Btn Form={ModalForm} className="center-block" onClose={onClose}>Click to open</Btn></div>
      </section>
      <section className="modal-btn-flow-fullheight-static">
        ...
        <div className="content"><Btn Forms={[StaticModal1,StaticModal2,StaticModal3]} labels={["First","Second","Third"]} className="fullheight" onClose={onClose}>Click to open</Btn></div>
      </section>
      <section className="modal-btn-flow-center-block-static">
        ...
        <div className="content"><Btn Forms={[StaticModal1,StaticModal2,StaticModal3]} labels={["First","Second","Third"]} className="center-block" onClose={onClose}>Click to open</Btn></div>
      </section>
    </div>
  }
}